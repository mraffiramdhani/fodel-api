<h1 align="center">Fodel-API - Food Delivery App RESTfull API</h1>



Fodel-API is a Food Delivery RESTful API. Built with NodeJs using the ExpressJs Framework.
...
## How to run the app ?
1. Clone this repository to your local directory (e.g: ~/dev/javascript/fodel-api)
